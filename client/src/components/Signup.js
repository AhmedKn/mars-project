    ...
    return(
     <div className="bg-sign">
      ...
      <form className="signup">
        ...
        <div className="form-group">
          <input value={this.state.region} onChange={(e) => this.handleChange(e)} name="region" type="text" placeholder="Country" className="form-control" required autoComplete="off"/>
        </div>
        <div className="form-group">
