    ...
    render(){
        ...
        <div className="forum-section">
          ...
          <div className="comment-box">
                ...
                <button onClick={() => this.send({newmessage:this.state.message,username:decoded.firstname,newtype:this.state.type,newtype:this.state.type,newdate:this.state.date,newacctype:decoded.acctype,newregion:decoded.region})}>send</button>
                  </div> 
